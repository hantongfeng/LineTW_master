...
def get_link_prediction_args(is_evaluation: bool = False):
    ...
    parser.add_argument('--dataset_name', type=str, help='dataset to be used', default='wikipedia',
                        choices=['wikipedia', 'reddit', 'enron', 'uci',  'CanParl'])
    parser.add_argument('--batch_size', type=int, default=200, help='batch size')
    parser.add_argument('--model_name', type=str, default='LineTW', help='name of the model, note that EdgeBank is only applicable for evaluation',
                        choices=['LineTW'])
    ...
    parser.add_argument('--walk_length', type=int, default=0, help='length of each random walk')
